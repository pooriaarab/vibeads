# vibeads Demo Video - Design Doc

## Concept: "The Dead Space"

**Duration:** ~30 seconds
**Audience:** a16z partners/investors, Twitter/X, GitHub README
**Tone:** Dark, cinematic, provocative. Film trailer energy.
**Core message:** Vibecoding creates dead time. vibeads fills it.

## Tech Stack

- **Remotion** (React-based video framework) for composition
- **ElevenLabs** for voiceover + background music
...
- Both glow cyan
- VO: "What if every idle moment became a recommendation?"
...
- Rapid montage, ~1.5s per placement with label overlay:
  ...
  3. CONTEXT INJECTION - Claude response with highlighted recommendation
  4. STACK ANALYSIS - Session start output with tech stack gaps
- Sharp cuts with bass hits
...
- Dark background. Visual metaphors:
  ...
  - 5 layered rectangles (placement tiers)
  - Single terminal prompt (one npm install)
...
- Audio: Final bass note, silence

## Voiceover Script (full)

"Three million developers vibecode every day. And while they wait... they stare at dead space. What if every idle moment became a recommendation? Contextual. Native. Five placement tiers, woven into the workflow. Twenty portfolio companies. Zero friction. One npm install."
